...
cut -f 1,4,5,7,9 $transcriptfile |awk 'BEGIN{FS="\t"; OFS="\t"}{split($5,a,";");split(a[3],b," ");split(a[5],c," ");print substr(b[2],2,length(b[2])-2),substr(c[2],2, length(c[2])-2),$1,$2,$3,$4}' >> $transcriptProbemap
