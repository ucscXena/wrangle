...
def humanmethylation450_GBM (inDir, outDir, cancer,flog,REALRUN):
    cancer ="GBM"
    PATHPATTERN= "HumanMethylation450"
    humanmethylation (inDir, outDir, cancer,flog, PATHPATTERN,BETAOFFSET,REALRUN)
    return

def humanmethylation450_LGG (inDir, outDir, cancer,flog,REALRUN):
    cancer ="LGG"
    PATHPATTERN= "HumanMethylation450"
    humanmethylation (inDir, outDir, cancer,flog, PATHPATTERN,BETAOFFSET,REALRUN)
    return
...
def humanmethylation (inDir, outDir, cancer,flog,PATHPATTERN,BETAOFFSET,REALRUN):
    ...
    J["wrangling_procedure"]= "Level_2 data download from TCGA DCC, processed at UCSC into cgData repository"
