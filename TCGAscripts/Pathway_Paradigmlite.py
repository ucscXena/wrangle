...
#        J["version"]= datetime.date.today().isoformat()
        ...
        if pattern=="CNV":
            J["description"]= "The dataset shows the input copy number (CNV) data used to derive the PARADIGMLITE inferred gene activities in TCGA "+ TCGAUtil.cancerOfficial[cancer]+" ("+cancer+") datasets."+\
        ...
        if pattern=="Expression":
            J["description"]= "The dataset shows the input gene expression data used to derive the PARADIGMLITE inferred gene activities in TCGA "+ TCGAUtil.cancerOfficial[cancer]+" ("+cancer+") dataset."+\
